...
A curated list of leading survey, feedback, and experience management platforms for market research, customer experience (CX), employee feedback, academic studies, and form-based data collection.  
...
Surveys and feedback collection have an excellent open-source ecosystem. Several modern projects offer Typeform-style experiences, full data ownership, advanced survey logic, and self-hosting with no per-response fees.



### Core Frameworks & Survey Platforms
...
- **Self-hosted survey stacks** — Deploy Formbricks, LimeSurvey, HeyForm, Typebot, or OpnForm with Docker for full data ownership and unlimited responses.

- **Research-grade setups** — LimeSurvey remains the standard for complex academic, governmental, and multi-language surveys.

- **In-app & product feedback** — Formbricks excels at targeted in-product and website micro-surveys.

- **Conversational experiences** — HeyForm and Typebot deliver high-completion, one-at-a-time survey flows.

- **Embedded surveys** — Form.io, SurveyJS, and custom form libraries for deep product integration.

- **Analysis pipelines** — Export to open statistical tools or build dashboards on top of self-hosted response databases.

- **Hybrid approaches** — Many teams run open-source survey tools for core data collection while using commercial platforms for panels or advanced XM features.



**Note:** Commercial platforms excel at polished UX, respondent panels, advanced statistical analysis, enterprise security/compliance certifications, and zero-ops hosting. Open-source solutions provide complete data ownership, no per-response pricing, transparency, and full customization — with Formbricks, LimeSurvey, HeyForm, and Typebot currently leading the modern open-source survey space.
...
Emphasizing open-source tools while documenting the major commercial platforms for context. Formbricks, LimeSurvey, HeyForm, Typebot, and OpnForm are the leading open-source survey and feedback platforms, offering strong alternatives to SurveyMonkey, Typeform, Qualtrics, and similar hosted tools with full data ownership and no per-response fees.
